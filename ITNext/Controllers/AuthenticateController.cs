...
namespace ITNext.Controllers
{
    public class AuthenticateController : Controller
    {
        ...
        public AuthenticateController(ITNextContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> AdminAuthenticate([Bind("Id,LoginUser,Password")] Authenticate Authenticate)
        {
            ...
            if ((Authenticate.LoginUser.Equals("ITNext@next.com") && Authenticate.Password.Equals("ITNext@next.com") ))
            {
        ...
        public async Task<IActionResult> UserAuthenticate([Bind("Id,LoginUser,Password")] Authenticate Authenticate)
        {
            ...
            if ((Authenticate.LoginUser.Equals("ITNext@next.com") && Authenticate.Password.Equals("ITNext@next.com") )|| AuthenticateData != null)
            {
